    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Monitor revenue and payment transactions</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="text-3xl font-bold text-gray-900">{activeUsers.toLocaleString()}</div>
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 md:hidden">
          {payments.map((payment, index) => (
